...
public class EnemyScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Only fire within a certain range
        //Don't fire if on cooldown/animation is already running
        if(enemyType == 3 && !anim.GetCurrentAnimatorStateInfo(0).IsName("MouthAttack") && attackTimer <= 0 && (player.transform.position - gameObject.transform.position).magnitude < 7)
        {
